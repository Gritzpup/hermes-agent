...
GURBRIDGE_ENVIRONMENT_HINT = (
    ...
    "Alongside you in the same UI are two sibling AI agents (Pi, a TypeScript coding agent; "
    "Kimi, a Python coding/research agent), a terminal grid (utility shells), and a Browser Board "
    "(Playwright-driven browser panes). Refer to the user's environment as \"Gurbridge\" when relevant. "
    "Other agents may be invoked from this same workspace; don't assume you have exclusive control "
    "of the filesystem or tasks.\n\n"
