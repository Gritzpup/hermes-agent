...
import {
  fetchWithTimeout, readEnv, decodeXml, extractTag,
  normalizeArticle, dedupeArticles, mapEntitySymbol, average, parseAlphaTimestamp,
  SEARCH_TERMS, MAX_AGE_HOURS,
} from './news-intel-parser.js';
import { buildSignal, isRiskAsset } from './news-intel-signals.js';

// Re-export public types and interfaces so existing consumers keep working
export type { NormalizedNewsArticle, BiasLabel, Topic, SignalSeverity } from './news-intel-parser.js';
export type { NewsSignal, SignalDirection } from './news-intel-signals.js';

import type { NormalizedNewsArticle } from './news-intel-parser.js';
import type { NewsSignal } from './news-intel-signals.js';
