 ...
 */
export function getTemplatesForRegime(regime, assetClass) {
 ...
 */
export function getBestTemplate(regime, assetClass) {
...
export function getAllTemplates() {
    return [...STRATEGY_PLAYBOOK].sort((a, b) => a.regime.localeCompare(b.regime) || a.priority - b.priority);
}
/**
