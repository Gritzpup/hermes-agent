...
export function rollToLiveSampleWindow(engine: any, agent: any, symbol: any): void {
...
export function applyAgentConfig(engine: any, agentId: string, config: any): boolean {
  ...
  engine.recordEvent('walk-forward', walkForward as unknown as Record<string, unknown>);
