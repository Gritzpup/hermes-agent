...
export function applyMistakeDrivenRefinement(engine, agent, symbol, profile, brokerPaperCrypto, frictionFloorBps) {
...
export function buildForensics(engine, entry) {
...
export function evaluateWalkForwardPromotion(engine, agent, candidate, champion) {
