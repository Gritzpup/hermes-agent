 ...
 */
export function computeEntryScore(style, shortReturn, mediumReturn, symbol, marketIntel) {
 ...
 */
export function getFeeRate(assetClass) {
 ...
 */
export function roundTripFeeBps(assetClass) {
