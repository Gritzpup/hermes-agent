...
import type { SymbolState, AgentState, PositionDirection } from './types.js';
...
export const {
  ...
  evaluateSessionKpiGate,
  evaluatePortfolioCircuitBreaker,
  evaluateCryptoExecutionGuard
} = risk;

export const {
  buildRegimeKpis,
  refreshCapitalAllocation,
  buildDeskAnalytics,
  buildExecutionBands,
...
export const {
  buildMistakeProfile,
  applyMistakeDrivenRefinement,
  applyAdaptiveTuning,
  evaluateChallengerProbation,
  buildForensics,
...
export function seedMarket(engine: any): void {
...
export function seedAgents(engine: any): void {
...
export function classifySymbolRegime(engine: any, symbol: SymbolState): string {
