...
export async function openBrokerPaperPosition(
  engine: any,
  agent: any,
  symbol: any,
  score: number,
...
export async function closeBrokerPaperPosition(engine: any, agent: any, symbol: any, reason: string): Promise<void> {
...
export function applyBrokerFilledEntry(
  engine: any,
  agent: any,
  symbol: any,
  report: any,
...
export function applyBrokerFilledExit(
  engine: any,
  agent: any,
  symbol: any,
  report: any,
...
export async function fetchBrokerAccount(engine: any, broker: BrokerId): Promise<any | null> {
  try {
...
export function finalizeBrokerFlat(engine: any, agent: any, symbol: any, reason: string): void {
  const position = agent.position;
  if (!position) {
    agent.pendingOrderId = null;
    agent.pendingSide = null;
